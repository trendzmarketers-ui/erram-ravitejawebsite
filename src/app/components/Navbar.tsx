...
const navLinks = ["Work", "Creative", "Ventures", "Projects", "About", "Contact", "Blog"];
...
export function Navbar() {
  ...
  /* When NOT scrolled (over dark hero) AND on home page, hide the navbar on desktop
  ...
  return (
    <nav
      ...
      style={{
        backgroundColor: scrolled || location.pathname !== "/" ? "rgba(255,255,255,0.92)" : "transparent",
        backdropFilter: scrolled || location.pathname !== "/" ? "blur(20px)" : "none",
        boxShadow: scrolled || location.pathname !== "/" ? "0 1px 20px rgba(0,0,0,0.06)" : "none",
        borderBottom: scrolled || location.pathname !== "/" ? "1px solid #EAEAEA" : "none",
